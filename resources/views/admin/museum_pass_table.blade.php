...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Museum Pass Transaction Record</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<script>
    const sAlert = (id, status) => {
      let ulink = document.location.origin+'/super-admin/museum-pass'
