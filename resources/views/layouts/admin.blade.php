            ...
            <!-- Navbar -->
                <nav class="main-header navbar navbar-expand navbar-dark">
                    ...
                    <li class="nav-item d-none d-sm-inline-block">
                        <a href="index3.html" class="nav-link">Back To Front Page</a>
                    </li>
                    {{-- <li class="nav-item d-none d-sm-inline-block">
            ...
            <!-- /.navbar -->
              ...
              <!-- Main Sidebar Container -->
                <aside class="main-sidebar sidebar-dark-primary elevation-4">
                    ...
                    {{-- <span class="brand-text font-weight-light">Istanbul Airport</span> --}}
                    </a>
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        ...
                        <div class="info">
                        <a href="#" class="d-block">Justice Kelechi</a>
                        </div>
                    </div>
                    ...
                    <nav class="mt-2">
                        ...
                        <li class="nav-item">
                            <a href="{{route('super-admin-istanbul-tours')}}" class="nav-link">
